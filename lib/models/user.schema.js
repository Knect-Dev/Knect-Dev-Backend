...
const userSchema = (sequelize, DataTypes) => sequelize.define('User', {
  ...
  role: { type: DataTypes.STRING, required: false, default: 'user' },
  approvedViewer: { type: DataTypes.ARRAY, default: [], required: false },
  Jobs: { type: DataTypes.ARRAY, default: [], required: false }
});
